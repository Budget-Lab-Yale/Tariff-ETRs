...
- `load_scenario_config()`: Loads all config YAMLs from a single directory into a named list. Tariff files (232, IEEPA, s122, s301) are optional; missing = NULL = zero rates. MFN rates loaded from `other_params$mfn_rates` path.
